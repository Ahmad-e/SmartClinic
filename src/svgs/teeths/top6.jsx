...
import Test from '../../images/36.png';
    ...
    return(
        <div>
            ...
            className={  ( props. reverse===true ? "teeth_svg_reverse" :"" ) + ' teeth_svg ' + (props.rotate===true ? ("teeth_svg_top") : ("")) + ( props.error ? " btn_svg_dignose":" ") }
                width="50.000000pt" height="50.000000pt" viewBox="0 0 113.000000 188.000000"
                preserveAspectRatio="xMidYMid meet">
                
                <g transform="translate(0.000000,188.000000) scale(0.100000,-0.100000)"
                fill="#fff" stroke="none">
                <path d="M265 1672 c-86 -53 -100 -378 -25 -549 l19 -43 344 0 344 0 11 38 c6
                20 23 96 38 167 33 163 30 249 -13 334 -33 66 -65 83 -116 61 -18 -8 -69 -14
                -117 -14 -66 -1 -91 -5 -112 -20 -27 -18 -29 -18 -55 0 -20 13 -58 20 -133 26
                -58 4 -116 10 -130 13 -16 4 -36 -1 -55 -13z"/>
                <path d="M267 1033 c-11 -10 -8 -227 3 -328 25 -216 94 -381 174 -419 103 -49
                134 33 151 389 7 143 26 255 50 291 22 34 51 30 72 -8 15 -29 18 -74 23 -333
                5 -259 8 -304 23 -332 17 -32 37 -40 72 -27 40 16 92 181 115 369 13 99 16
                350 5 384 -6 21 -9 21 -344 21 -186 0 -341 -3 -344 -7z"/>
                </g>
            </svg> */}
        </div>
    )
